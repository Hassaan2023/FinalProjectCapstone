import { useQuery, useMutation, useQueryClient, useInfiniteQuery, useMutationState, } from "@tanstack/react-query";
...
export const useCreateUserAccount = () => {
  ...
  export const useGetPosts = () => {
    return useInfiniteQuery({
      ...
      // Add initialPageParam here, it can be null or some initial value
